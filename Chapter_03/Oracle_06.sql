...
-- Simple regex
SELECT DESCRITOR FROM PRODUTOS WHERE SUBSTR(DESCRITOR,1,15) LIKE 'Sabor dos Alpes';
-- Another way to same result
SELECT DESCRITOR FROM PRODUTOS WHERE SUBSTR(DESCRITOR,1,15) = 'Sabor dos Alpes';

-- Delete all 'Sabor dos Alpes'
DELETE FROM PRODUTOS WHERE SUBSTR(DESCRITOR, 1,15) = 'Sabor dos Alpes';
